...
export default function RecetasPage() {
  ...
  function agregarIngrediente() {
    ...
    if (!insumo) return
    const ppu = insumo.precio / insumo.cantidad
      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '24px 16px' }}>
        ...
        <div style={{ background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 12, padding: 16, marginBottom: 20 }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr auto', gap: 8, marginBottom: 10 }}>
            ...
            <div>
              <label style={{ fontSize: 11, color: 'var(--muted)', display: 'block', marginBottom: 4 }}>CANTIDAD</label>
              <input style={inp} type="number" value={cantSel} onChange={e => setCantSel(e.target.value)} placeholder="0" />
            </div>
